...
def analysis_features(tasks, stages):
    ...
    def find_straggler(tasks, stages, features, threshold=1.2):
...
#        print('find %d stragglers' % (len(stragglers)))
        ...
        #f = open('/home/hadoop/qwc_trace/analysis/app_straggler','w')
    ...
    def cal_nodes(stragglers):
        ...
        for task_id in stragglers:
            ...
            node_id = int(getId(task['Task Info']['Host']))
    ...
    for task_id in tasks:
        ...
        feature['node_id'] = getId(task['Task Info']['Host'])
    ...
    '''
    #os.system("cp /home/hadoop/"+str(seed)+"tree.dot ./tree.dot")
...
def read_hardware_log(filename, timestamp=0, features=[]):
    with open(filename) as log:
        ...
        while True:
            ...
            t_features=[timestamp]
            for t_feature in features:
                t_features.append(t_feature)
            rt.append([values[index] for index in t_features])
...
def wraper(tasks, start_time, extracted_features):
    ...
    # '''
    # get iostat
    io_files = [LOG_DIR + '/out_log/iostat_out_slave1', LOG_DIR + '/out_log/iostat_out_slave2',
                LOG_DIR + '/out_log/iostat_out_slave3', LOG_DIR + '/out_log/iostat_out_slave4',
                LOG_DIR + '/out_log/iostat_out_slave5']
    ...
    # '''
    # cpu_features
    cpu_files = [LOG_DIR + '/out_log/mpstat_out_slave1', LOG_DIR + '/out_log/mpstat_out_slave2',
                 LOG_DIR + '/out_log/mpstat_out_slave3', LOG_DIR + '/out_log/mpstat_out_slave4',
                 LOG_DIR + '/out_log/mpstat_out_slave5']
    cpu_features = []
    ...
    # net_features
    net_files = [LOG_DIR + '/out_log/sar_out_slave1', LOG_DIR + '/out_log/sar_out_slave2',
                 LOG_DIR + '/out_log/sar_out_slave3', LOG_DIR + '/out_log/sar_out_slave4',
                 LOG_DIR + '/out_log/sar_out_slave5']
    net_features = []
...
if __name__ == '__main__':
    ...
    #for task_id in tasks:
        #mat.append([tasks[task_id]['cpu'],tasks[task_id]['io'],tasks[task_id]['net']])
    keys = []
    dataset = []
    labels = []
    flag_key = True
